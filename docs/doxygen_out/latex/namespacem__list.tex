...
\begin{DoxyCompactItemize}
\item 
character(len= $\ast$), parameter \mbox{\hyperlink{namespacem__list_a5b8d48a0fc3218e8ed1d263a73748a27}{ident\+\_\+1}} =\char`\"{}@(\#)M\+\_\+list\+::locate(3f)\+: Generic subroutine locates where element is or should be in sorted allocatable array\char`\"{}
\item 
character(len= $\ast$), parameter \mbox{\hyperlink{namespacem__list_a25c880ddb1248291f9b143e99fd80870}{ident\+\_\+2}} =\char`\"{}@(\#)M\+\_\+list\+::insert(3f)\+: Generic subroutine inserts element into allocatable array at specified position\char`\"{}
\item 
character(len= $\ast$), parameter \mbox{\hyperlink{namespacem__list_a47ce2be826f94ee09c3b15b367504866}{ident\+\_\+3}} =\char`\"{}@(\#)M\+\_\+list\+::replace(3f)\+: Generic subroutine replaces element from allocatable array at specified position\char`\"{}
\item 
character(len= $\ast$), parameter \mbox{\hyperlink{namespacem__list_a9ff7bfbdf866c8a3a9fc831c228ce065}{ident\+\_\+4}} =\char`\"{}@(\#)M\+\_\+list\+::remove(3f)\+: Generic subroutine deletes element from allocatable array at specified position\char`\"{}
\item 
...
\mbox{\Hypertarget{namespacem__list_a5b8d48a0fc3218e8ed1d263a73748a27}\label{namespacem__list_a5b8d48a0fc3218e8ed1d263a73748a27}} 
\index{m\+\_\+list@{m\+\_\+list}!ident\+\_\+1@{ident\+\_\+1}}
\index{ident\+\_\+1@{ident\+\_\+1}!m\+\_\+list@{m\+\_\+list}}
\subsubsection{\texorpdfstring{ident\+\_\+1}{ident\_1}}
{\footnotesize\ttfamily character(len=$\ast$), parameter m\+\_\+list\+::ident\+\_\+1 =\char`\"{}@(\#)M\+\_\+list\+::locate(3f)\+: Generic subroutine locates where element is or should be in sorted allocatable array\char`\"{}\hspace{0.3cm}{\ttfamily [private]}}

\mbox{\Hypertarget{namespacem__list_a25c880ddb1248291f9b143e99fd80870}\label{namespacem__list_a25c880ddb1248291f9b143e99fd80870}} 
\index{m\+\_\+list@{m\+\_\+list}!ident\+\_\+2@{ident\+\_\+2}}
\index{ident\+\_\+2@{ident\+\_\+2}!m\+\_\+list@{m\+\_\+list}}
\subsubsection{\texorpdfstring{ident\+\_\+2}{ident\_2}}
{\footnotesize\ttfamily character(len=$\ast$), parameter m\+\_\+list\+::ident\+\_\+2 =\char`\"{}@(\#)M\+\_\+list\+::insert(3f)\+: Generic subroutine inserts element into allocatable array at specified position\char`\"{}\hspace{0.3cm}{\ttfamily [private]}}

\mbox{\Hypertarget{namespacem__list_a47ce2be826f94ee09c3b15b367504866}\label{namespacem__list_a47ce2be826f94ee09c3b15b367504866}} 
\index{m\+\_\+list@{m\+\_\+list}!ident\+\_\+3@{ident\+\_\+3}}
\index{ident\+\_\+3@{ident\+\_\+3}!m\+\_\+list@{m\+\_\+list}}
\subsubsection{\texorpdfstring{ident\+\_\+3}{ident\_3}}
{\footnotesize\ttfamily character(len=$\ast$), parameter m\+\_\+list\+::ident\+\_\+3 =\char`\"{}@(\#)M\+\_\+list\+::replace(3f)\+: Generic subroutine replaces element from allocatable array at specified position\char`\"{}\hspace{0.3cm}{\ttfamily [private]}}

\mbox{\Hypertarget{namespacem__list_a9ff7bfbdf866c8a3a9fc831c228ce065}\label{namespacem__list_a9ff7bfbdf866c8a3a9fc831c228ce065}} 
\index{m\+\_\+list@{m\+\_\+list}!ident\+\_\+4@{ident\+\_\+4}}
\index{ident\+\_\+4@{ident\+\_\+4}!m\+\_\+list@{m\+\_\+list}}
\subsubsection{\texorpdfstring{ident\+\_\+4}{ident\_4}}
{\footnotesize\ttfamily character(len=$\ast$), parameter m\+\_\+list\+::ident\+\_\+4 =\char`\"{}@(\#)M\+\_\+list\+::remove(3f)\+: Generic subroutine deletes element from allocatable array at specified position\char`\"{}\hspace{0.3cm}{\ttfamily [private]}}
